...
/****** Object:  Job [_DBA_Information]    Script Date: 02/08/2017 08:46:24 ******/
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 02/08/2017 08:46:24 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Physical Disk Usage]    Script Date: 02/08/2017 08:46:25 ******/
...
Write-DataTable -ServerInstance $Instance -Database "DBA" -TableName "Data_SystemDisk" -Data ($Disks | Out-DataTable)', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Login Data]    Script Date: 02/08/2017 08:46:25 ******/
...
EXEC DBA.dbo.sp_auditlogindb', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Server Information]    Script Date: 02/08/2017 08:46:25 ******/
...
EXEC DBA.dbo.sp_GetSqlInstInfo @ForceUpdateAll', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database Information]    Script Date: 02/08/2017 08:46:25 ******/
...
EXEC DBA.dbo.spGetDatabaseFiles', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Configuration Changes]    Script Date: 02/08/2017 08:46:25 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Configuration Changes', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Agent Job Data]    Script Date: 02/08/2017 08:46:25 ******/
...
EXEC DBA.dbo.sp_agntJobHist', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Logging Cleanup]    Script Date: 02/08/2017 08:46:25 ******/
