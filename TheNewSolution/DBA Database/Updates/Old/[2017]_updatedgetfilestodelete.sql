...
/****** Object:  StoredProcedure [dbo].[sp_Getbckfilestodel]    Script Date: 02/08/2017 2:58:13 PM ******/
SET ANSI_NULLS ON
GO
...
WHERE T.ExpectedType = 'D'
	AND DBA.dbo.fnTrimTime(B.DateBackupSetExpires) < DBA.dbo.fnTrimTime(GETDATE())
