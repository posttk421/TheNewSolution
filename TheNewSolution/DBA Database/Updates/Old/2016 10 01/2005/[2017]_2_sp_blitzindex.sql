...
/*
sp_BlitzIndex (TM) v2.0 - April 8, 2016
...
CHANGE LOG (last five versions):
	May 14, 2016 (v2.0) - Added data types and max length to all columns (keys, includes, secret columns)
	...
	April 8, 2016 (v1.5) - Fixed breaking bug for partitioned tables with > 10(ish) partitions
...
BEGIN TRY
	BEGIN
		...
		RAISERROR(N'Starting run. sp_BlitzIndex version 2.0 (May 15, 2016)', 0,1) WITH NOWAIT;
...
BEGIN
	...
	WITH table_mode_cte AS (
		...
		UNION ALL
		SELECT 				
				N'sp_BlitzIndex version 2.0 (May 15, 2016)' ,   
...
BEGIN;
	...
	BEGIN;
		...
		VALUES  ( 0 , N'Database=' + @database_name, N'sp_BlitzIndex version 2.0 (May 15, 2016)' ,
				...
				INSERT	#blitz_index_results ( check_id, index_sanity_id, findings_group, finding, URL, details, index_definition,
						...
						SELECT	69 AS check_id, 
								...
								i.schema_object_name 
									...
									+ N' with a different collation Dustin the db collation of '
