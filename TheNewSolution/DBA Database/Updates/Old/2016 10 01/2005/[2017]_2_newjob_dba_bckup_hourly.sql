...
/****** Object:  Job [_DBA_Backup_Hourly]    Script Date: 02/08/2017 1:47:34 PM ******/
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 02/08/2017 1:47:34 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Phase 1 - Create Folder Structure]    Script Date: 02/08/2017 1:47:34 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Phase 1 - Create Folder Structure', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Phase 2 - Backup Database]    Script Date: 02/08/2017 1:47:34 PM ******/
...
EXEC DBA.dbo.spBackupDatabase NULL, ''L'', 0;', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Phase 3 - Gather Data]    Script Date: 02/08/2017 1:47:34 PM ******/
