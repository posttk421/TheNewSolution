...
Changes in v6 Dec 26 2011:
 - Dustin Allen @FatherJack suggested tweaking sp_BlitzUpdate's error message
    ...
    if @SkipChecksTable is not null
      begin 
        ...
        begin 
          ...
          set @DbName = (select DatabaseName from #exempt where ID = @ID)
