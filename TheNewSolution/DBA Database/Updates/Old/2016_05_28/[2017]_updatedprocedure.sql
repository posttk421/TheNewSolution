...
/****** Object:  StoredProcedure [dbo].[sp_Getbckfilestodel]    Script Date: 02/08/2017 11:27:09 ******/
SET ANSI_NULLS ON
GO
...
WHERE T.ExpectedType = 'D'
	AND CAST(B.DateExpire AS DATE) <= CAST(GETDATE() AS DATE)
