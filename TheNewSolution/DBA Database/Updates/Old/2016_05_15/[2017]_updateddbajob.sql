...
/****** Object:  Job [_DBA_Backup]    Script Date: 02/08/2017 3:11:17 PM ******/
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 02/08/2017 3:11:18 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Cleanup Phase 1 - Gather Data]    Script Date: 02/08/2017 3:11:18 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Cleanup Phase 1 - Gather Data', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Cleanup Phase 2 - Delete Old Database Backup Files]    Script Date: 02/08/2017 3:11:19 PM ******/
...
ForEach ($Row in ($FilesToDelete))
{
	...
	$Query = "UPDATE DBA.dbo.Data_BackupMediaFiles SET DateFileDeleted = GETDATE() WHERE DateFileDeleted IS NULL FilePathName = ''" + $File + "''"
	Invoke-SqlCmd -Query $Query -Database "DBA" -ServerInstance $Instance
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Cleanup Phase 3 - Remove old database Object script files]    Script Date: 02/08/2017 3:11:19 PM ******/
...
Invoke-SqlCmd -Query "UPDATE Data_ObjectBackupHistory SET DateRemoved = GETDATE() WHERE DateRemoved IS NULL" -Database "DBA" -ServerInstance $Instance', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 1 - Create Folder Structure]    Script Date: 02/08/2017 3:11:19 PM ******/
...
ForEach ($Row in ($Folders))
{
	...
	If ((Test-Path -Path $Folder -PathType Container) -eq $false)
	{
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 2 - Database]    Script Date: 02/08/2017 3:11:19 PM ******/
...
EXEC DBA.dbo.spBackupDatabase @DbName, @BackupType, @IsDebug', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3a - SQL Agent Jobs]    Script Date: 02/08/2017 3:11:19 PM ******/
...
$MasterList | Export-Csv ($RootFolder + "!Agent Job List.csv") -NoTypeInformation -NoClobber -Encoding ASCII', 
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3b - Backup Logins]    Script Date: 02/08/2017 3:11:19 PM ******/
...
', 
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3c - Roles]    Script Date: 02/08/2017 3:11:20 PM ******/
...
$MasterList | Export-Csv ($RootFolder + "!Role List.csv") -NoTypeInformation -NoClobber -Encoding ASCII', 
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3d - Schemas]    Script Date: 02/08/2017 3:11:20 PM ******/
...
$MasterList | Export-Csv ($RootFolder + "!Schema List.csv") -NoTypeInformation -NoClobber -Encoding ASCII', 
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3e - SSIS Packages]    Script Date: 02/08/2017 3:11:20 PM ******/
...
', 
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3f - Database Build Scripts]    Script Date: 02/08/2017 3:11:20 PM ******/
...
ForEach ($Database In ($SMO.databases | Where-Object {$_.IsSystemObject -eq $false}))
{
	...
	Invoke-SqlCmd -Query $Query -ServerInstance $Instance -Database "DBA"
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3g - Linked Servers]    Script Date: 02/08/2017 3:11:20 PM ******/
...
ForEach ($LinkedServer IN $SMO.LinkedServers)
{
	...
	Invoke-SqlCmd -Query $Query -ServerInstance $Instance -Database "DBA"
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3h - SSAS]    Script Date: 02/08/2017 3:11:20 PM ******/
...
', 
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 4 - Update Agent Job History]    Script Date: 02/08/2017 3:11:21 PM ******/
...
EXEC DBA.dbo.sp_agntJobHist', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Logging Cleanup]    Script Date: 02/08/2017 3:11:21 PM ******/
