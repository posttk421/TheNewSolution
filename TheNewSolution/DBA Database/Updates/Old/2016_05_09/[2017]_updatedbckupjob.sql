...
/****** Object:  Job [_DBA_Backup]    Script Date: 02/08/2017 8:55:52 AM ******/
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 02/08/2017 8:55:52 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Cleanup Phase 1 - Gather Data]    Script Date: 02/08/2017 8:55:52 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Cleanup Phase 1 - Gather Data', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Cleanup Phase 2 - Delete Old Database Backup Files]    Script Date: 02/08/2017 8:55:52 AM ******/
...
ForEach ($Row in ($FilesToDelete))
{
	...
	If ((Test-Path -Path $File -PathType Leaf) -eq $true)
	{
		...
		#The file must be created before midnight of the current day. 
		If ($FileInfo.CreationTime -lt (Get-Date).Date)
		{
			#Remove the File...
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Cleanup Phase 3 - Remove old database Object script files]    Script Date: 02/08/2017 8:55:52 AM ******/
...
Invoke-SqlCmd -Query "UPDATE Data_ObjectBackupHistory SET DateRemoved = GETDATE() WHERE DateRemoved IS NULL" -Database "DBA" -ServerInstance $Instance', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 1 - Create Folder Structure]    Script Date: 02/08/2017 8:55:52 AM ******/
...
ForEach ($Row in ($Folders))
{
	...
	If ((Test-Path -Path $Folder -PathType Container) -eq $false)
	{
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 2 - Database]    Script Date: 02/08/2017 8:55:52 AM ******/
...
EXEC DBA.dbo.spBackupDatabase @DbName, @BackupType, @IsDebug', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3a - SQL Agent Jobs]    Script Date: 02/08/2017 8:55:52 AM ******/
...
$MasterList | Export-Csv ($RootFolder + "!Agent Job List.csv") -NoTypeInformation -NoClobber -Encoding ASCII', 
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3b - Backup Logins]    Script Date: 02/08/2017 8:55:52 AM ******/
...
', 
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3c - Roles]    Script Date: 02/08/2017 8:55:52 AM ******/
...
$MasterList | Export-Csv ($RootFolder + "!Role List.csv") -NoTypeInformation -NoClobber -Encoding ASCII', 
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3d - Schemas]    Script Date: 02/08/2017 8:55:53 AM ******/
...
$MasterList | Export-Csv ($RootFolder + "!Schema List.csv") -NoTypeInformation -NoClobber -Encoding ASCII', 
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3e - SSIS Packages]    Script Date: 02/08/2017 8:55:53 AM ******/
...
', 
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3f - Database Build Scripts]    Script Date: 02/08/2017 8:55:53 AM ******/
...
ForEach ($Database In ($SMO.databases | Where-Object {$_.IsSystemObject -eq $false}))
{
	...
	Invoke-SqlCmd -Query $Query -ServerInstance $Instance -Database "DBA"
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3g - Linked Servers]    Script Date: 02/08/2017 8:55:53 AM ******/
...
ForEach ($LinkedServer IN $SMO.LinkedServers)
{
	...
	Invoke-SqlCmd -Query $Query -ServerInstance $Instance -Database "DBA"
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 3h - SSAS]    Script Date: 02/08/2017 8:55:53 AM ******/
...
try
{
	...
	Write-Host "Server Not Present or Not Online."
	Exit
}
...
', 
		...
		@flags=32
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup Phase 4 - Update Agent Job History]    Script Date: 02/08/2017 8:55:53 AM ******/
...
EXEC DBA.dbo.sp_agntJobHist', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Logging Cleanup]    Script Date: 02/08/2017 8:55:53 AM ******/
