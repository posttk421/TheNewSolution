...
/****** Object:  Job [_DBA_Information]    Script Date: 8/6/2016 3:47:19 PM ******/
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 8/6/2016 3:47:19 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Physical Disk Usage]    Script Date: 8/6/2016 3:47:19 PM ******/
...
Write-DataTable -ServerInstance $Instance -Database "DBA" -TableName "Data_SystemDisk" -Data ($Disks | Out-DataTable)', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Login Data]    Script Date: 8/6/2016 3:47:19 PM ******/
...
EXEC DBA.dbo.sp_auditlogindb', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Server Information]    Script Date: 8/6/2016 3:47:19 PM ******/
...
EXEC DBA.dbo.sp_GetSqlInstInfo @ForceUpdateAll', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database Information]    Script Date: 8/6/2016 3:47:19 PM ******/
...
EXEC DBA.dbo.spGetDatabaseFiles', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Error and Trace Log Reading and Analysis]    Script Date: 8/6/2016 3:47:19 PM ******/
...
EXEC DBA.dbo.sp_GetSqlTrcInfo', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Agent Job Data]    Script Date: 8/6/2016 3:47:19 PM ******/
...
EXEC DBA.dbo.sp_agntJobHist', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Logging Cleanup]    Script Date: 8/6/2016 3:47:19 PM ******/
