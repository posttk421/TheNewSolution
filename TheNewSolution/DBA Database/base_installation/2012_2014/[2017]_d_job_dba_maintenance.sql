...
/****** Object:  Job [_DBA_Maintenance]    Script Date: 8/6/2016 3:47:43 PM ******/
EXEC msdb.dbo.sp_delete_job @job_name=N'_DBA_Maintenance', @delete_unused_schedule=1
GO
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 8/6/2016 3:47:43 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Index Defragmentation]    Script Date: 8/6/2016 3:47:43 PM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Consistency Check]    Script Date: 8/6/2016 3:47:44 PM ******/
...
EXEC DBA.dbo.spDBCCCheckDB @DbName = @DbName', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Logging Cleanup]    Script Date: 8/6/2016 3:47:44 PM ******/
